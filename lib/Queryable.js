    ...
    bind(context) {
        return __awaiter(this, void 0, Promise, function* () {
            ...
            if (data) {
                ...
                yield Reflect.ownKeys(a).forEach((key) => {
                    let f = a[key];
                    if (f instanceof Entity_1.Field) {
                        let name = Case.snake(key);
                        let type = new String();
                        if (f instanceof Entity_1.StringField) {
                            type = "string";
                        }
                        else if (f instanceof Entity_1.NumberField) {
                            type = "number";
                        }
                        else if (f instanceof Entity_1.BooleanField) {
                            type = "boolean";
                        }
                        else if (f instanceof Entity_1.DateField) {
                            type = "date";
                        }
